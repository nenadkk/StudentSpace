...
class DBAccess {
    ...
    private const HOST_DB = "localhost";           // docker = db,         server_tecweb = localhost
    private const DATABASE_NAME = "sdeblasi"; // docker = testdb,     server_tecweb = nome_utente
    private const USERNAME = "sdeblasi";        // docker = user,       server_tecweb = nome_utente
    private const PASSWORD = "ithohhiuhahCh9Sh";    // docker = password,   server_tecweb = password_server
    private $connection;
