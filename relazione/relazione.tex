...
La gestione degli errori viene effettuata sia tramite codice PHP restituendo la pagina personalizzata relativa all'errore specifico ma anche attraverso il
...
\begin{itemize}
    \item \textbf{NVDA}: per testare la gerarchia dei titoli, dei link e dei punti di riferimento, la navigazione tramite landmark e l’annuncio dei messaggi di errore nei form, sia con JavaScript attivo sia disattivato (vedi Figure~\ref{fig:NVDA1} e~\ref{fig:NVDA2}).
\end{itemize}
