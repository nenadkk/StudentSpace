...
Il progetto segue una chiara separazione tra: \textbf{presentazione} (HTML e CSS), \textbf{comportamento} (JavaScript), \textbf{logica applicativa} (PHP) e \textbf{persistenza} (database).
