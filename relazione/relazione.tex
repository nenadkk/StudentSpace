...
\begin{itemize}
    ...
    \item quando un errore compare per la prima volta, il contenuto del campo viene selezionato per facilitare la correzione.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Uniformità}: stesso markup, stessi stili e stessa semantica dei messaggi generati lato client, garantendo un’esperienza coerente indipendentemente dalla presenza di JavaScript.
\end{itemize}
